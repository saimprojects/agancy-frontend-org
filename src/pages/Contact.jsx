  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      value: 'info@saienterprises.com',
      href: 'mailto:info@saienterprises.com'
    },
    {
      icon: Phone,
      title: 'Phone',
            ...
            >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-primary text-primary-foreground px-8 py-4 rounded-lg font-semibold hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                >
                  {isSubmitting ? (
                    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground">
              We'd love to meet you in person. Drop by our office for a coffee and a chat.
            </p>
          </motion.div>
